    ...
    protected function _initLanguage()
    {
        ...
        if($this->_isMultiLanguageEnabled()){
            ...
            $frontController->registerPlugin(new Core_Controller_Plugin_Language(
                    $locale,
                    $languagesModel->getLanguagesShortCodes(),
                    $domainsModel->getLanguageDomainMap(),
                    $languagesModel->getDefaultLanguageShortCode()
                ));
        }else{
    ...
    {        
        ...
        $this->getResource('frontController')
                ->registerPlugin(new Core_Controller_Plugin_SystemMessages(
                        $view, 
                        $systemMessagesConfig->scriptPath, 
                        $systemMessagesConfig->layout
                    )
                );
    }
